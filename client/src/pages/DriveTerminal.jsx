...
import DriveTerminalForm from "../components/DriveTerminal/DriveTerminalCard";
import { GET_SERVICES, ADD_SERVICE } from "../utils/queries";

const DriveTerminal = () => {
    console.log("DriveTerminal component is rendering");
    ...
    return (
        <div>
            ...
            {showForm && <DriveTerminalForm componentId={componentId} />}
            <h2>DriveTerminal Services</h2>
